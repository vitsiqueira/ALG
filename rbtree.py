class Node:
  ...
  def __init__(self, key, color = RED):
    if not type(color) == bool:
      raise TypeError("Valor incorreto. Era esperado True/False, mas dado %s" % color)
    self.color = color
    self.key = key
...
:::::::::::::
        ...
        2 - Para deletar;
        3 - Para buscar; 
        4 - Para receber o valor mínimo;
        5 - Para receber o valor máximo;
        6 - Para receber o sucessor;
        7 - Para receber o predecessor;
    """)
    ...
    if rbtop == "1":
        x = int(input("Informe o número que deseja inserir: "))
        arvore.add(x)
        continue;

    if rbtop == "2":
        x = int(input("Informe o número que deseja deletar: "))
        arvore.delete(x)
        continue;

    if rbtop == "3":
        x = int(input("Informe o número que deseja buscar: "))
        arvore.search(x)
        continue;
    ...
    if rbtop == "6":
        x = int(input("Informe o número que se deseja o sucessor: "))
        arvore.successor(x)
        continue;

    if rbtop == "7":
        x = input("Informe o número que se deseja o predecessor: ")
